...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, input_chan, zero_init_residual=False,
        ...
        self.conv1 = nn.Conv2d(input_chan, planes[0], kernel_size=7, stride=2, padding=3,
                               bias=False)
...
if __name__ == '__main__':
    net = resnet34(input_chan=12)
    rand_input = torch.randn(1, 12, 84, 84)
